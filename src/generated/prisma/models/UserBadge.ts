...
export type UserBadgeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"earnedAt" | "userId" | "badgeId", ExtArgs["result"]["userBadge"]>
...
export interface UserBadgeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `earnedAt`
   * const userBadgeWithEarnedAtOnly = await prisma.userBadge.findMany({ select: { earnedAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserBadges and only return the `earnedAt`
   * const userBadgeWithEarnedAtOnly = await prisma.userBadge.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more UserBadges and only return the `earnedAt`
   * const userBadgeWithEarnedAtOnly = await prisma.userBadge.updateManyAndReturn({
   *   select: { earnedAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
